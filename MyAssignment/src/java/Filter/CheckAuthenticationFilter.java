...
public class CheckAuthenticationFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("CheckAuthenticationFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("CheckAuthenticationFilter:DoAfterProcessing");
        }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("CheckAuthenticationFilter()");
        }
        StringBuffer sb = new StringBuffer("CheckAuthenticationFilter(");
