                            ...
                            <c:forEach var="product" items="${products}">
                                <td>
                                    <input type="number" name="quantity_${product.id}_K1" 
                                           value="${quantityMap[product.id][currentDate][1] != null ? quantityMap[product.id][currentDate][1] : ''}" min="0" />
                                </td>
                                <td>
                                    <input type="number" name="quantity_${product.id}_K2" 
                                           value="${quantityMap[product.id][currentDate][2] != null ? quantityMap[product.id][currentDate][2] : ''}" min="0" />
                                </td>
                                <td>
                                    <input type="number" name="quantity_${product.id}_K3" 
                                           value="${quantityMap[product.id][currentDate][3] != null ? quantityMap[product.id][currentDate][3] : ''}" min="0" />
                                </td>
                            </c:forEach>
                        </tr>
                    </c:forEach>
